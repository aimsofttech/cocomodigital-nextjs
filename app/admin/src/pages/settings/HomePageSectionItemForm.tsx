...
export default function HomePageSectionItemForm({ onSuccess, onCancel, editId }: Props = {}) {
  ...
  const onSubmit = async (formData: any) => {
    try {
      if (isEdit && id) await homePageSectionItemApi.update(id, formData);
      else await homePageSectionItemApi.create(formData);
