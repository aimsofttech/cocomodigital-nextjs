  ...
  const form = (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div><label className="form-label">Client Name</label><input {...register('client_name')} className="form-input" placeholder="Enter client name" /></div>
        <div><label className="form-label">Service Type</label><input {...register('service_type')} className="form-input" placeholder="e.g. Video Production" /></div>
      </div>
