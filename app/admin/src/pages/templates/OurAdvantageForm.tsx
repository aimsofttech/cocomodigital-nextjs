    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input {...register('template_name')} className="form-input" placeholder="Enter template name" />
        </div>
        <div>
          <label className="form-label">Advantage Title <span className="text-red-500">*</span></label>
          <input {...register('advantage_title', { required: 'Required' })} className="form-input" placeholder="Enter advantage title" />
