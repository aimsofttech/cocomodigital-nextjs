...
export default function BannerTitleList() {
  ...
  const handleStatusChange = async (id: string, newStatus: number) => {
    try {
      await bannerTitleTemplateApi.update(id, { status: newStatus });
  ...
  const columns = [
    { key: 'banner_bg_img', label: 'Image', render: (row: any) => <ImageCell src={row.banner_bg_img} /> },
    { key: 'banner_name', label: 'Banner Name', sortable: true },
    { key: 'banner_title', label: 'Title', sortable: true },
