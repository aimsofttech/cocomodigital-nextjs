...
export default function OtherActivityCategoryForm({ onSuccess, onCancel, editId }: Props = {}) {
  ...
  useEffect(() => {
    if (isEdit && id) {
      marketingHouseOtherActivityCategoryApi.getOne(id).then(({ data }) => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      if (isEdit && id) await marketingHouseOtherActivityCategoryApi.update(id, payload);
