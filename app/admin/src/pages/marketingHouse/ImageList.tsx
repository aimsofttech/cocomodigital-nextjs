...
export default function ImageList() {
  ...
  return (
    <CrudListPage title="Marketing Images" breadcrumbs={[{ label: 'Marketing Campaigns' }, { label: 'Images' }]}
      ...
      modalTitle={(mode) => mode === 'edit' ? 'Update Marketing Image' : 'Add Marketing Image'}
      csv={{
