...
export default function OtherActivityItemForm({ onSuccess, onCancel, editId }: Props = {}) {
  ...
  const form = (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <div>
        ...
        <select {...register('marketing_house_other_activity_category_id')} className="form-select">
  ...
  return (
    <div>
      <PageHeader title={isEdit ? 'Edit Add-on Activities Item' : 'Add Add-on Activities Item'} breadcrumbs={[{ label: 'Add-on Activities Item', path: '../' }, { label: isEdit ? 'Edit' : 'Add' }]} />
