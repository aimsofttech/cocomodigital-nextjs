...
export default function CommunityProgramItemModuleList() {
  ...
  const { data, loading, submitting, pagination, remove, setSearch, setPage, setFilterParams, fetchAll } =
    useCrud(marketingHouseCommunityProgramItemApi, true, itemId ? { marketing_house_item_id: itemId } : {});
  ...
  return (
    <CrudListPage title={itemName ? `Continuity Items — ${itemName}` : 'Continuity Items'} breadcrumbs={[{ label: 'Marketing House' }, { label: 'Item Sections' }, { label: 'Continuity Items' }]}
