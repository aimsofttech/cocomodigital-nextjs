...
export default function ContentCategoryModuleList() {
  ...
  return (
    <CrudListPage title="Content Categories" breadcrumbs={[{ label: 'Marketing House' }, { label: 'Item Sections' }, { label: 'Content Categories' }]}
      columns={columns} data={data} loading={loading} submitting={submitting} pagination={pagination}
      onPageChange={setPage} onSearch={setSearch} onDelete={remove}
      filterFields={FILTER_FIELDS} onServerFilterChange={setFilterParams}
      renderModal={({ id, onSuccess, onCancel }) => <ContentCategoryModuleForm editId={id} onSuccess={onSuccess} onCancel={onCancel} />}
