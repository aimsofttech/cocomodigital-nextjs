...
export default function CreatorPlatformList() {
  ...
  const columns = [
    ...
    { key: 'creator_thumbnail_url', label: 'URL', sortable: true, render: (row: any) => row.creator_thumbnail_url ? <a href={row.creator_thumbnail_url} target="_blank" rel="noreferrer" className="text-primary-600 hover:underline text-xs">{row.creator_thumbnail_url}</a> : '—' },
