    ...
    children: [
      ...
      { label: 'Items',            path: '/marketing/item',             icon: ListBulletIcon },
      {
        ...
        children: [
          ...
          { label: 'Other Activities Categories', path: '/marketing/other-activity-category', icon: Squares2X2Icon },
          { label: 'Other Activities Items',      path: '/marketing/other-activity-item',     icon: ListBulletIcon },
